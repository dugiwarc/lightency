...
export const users = [
  ...
  },
  {
    ...
    position: "ADVISOR",
    social: {
      linkedin: "https://www.linkedin.com/in/gayatri-sarkar-3a995119/",
      facebook: "",
      twitter: ""
    },
    description:
      "Gayatri is a Blockchain VC, advisor and General Partner at Blockchain based Sports Venture Fund named SportVEST. She has 12 years of exp in fintech industry. Previously, she worked as manager at Federal Reserve Bank, Treasury, Goldman Sachs, IBM, HP, EU bank and has founded two startups.Her expertise is venture capital, fundraising, deal flow, strategy management, product development, fintech, big data. Her research and investment area is blockchain. She is an advocate of blockchain for climate control and an investor in crypto market. She is on the board of multiple Blockchain and non-Blockchain companies.She is a Harvard alum and sits on multiple Harvard Kennedy School alumni board.",
    image: gaya,
    tag: "advisor"
  },
  {
  ...
  },
  {
    ...
    position: "AMBASSADOR",
    social: {
      linkedin: "https://www.linkedin.com/in/pellel/",
      facebook: "",
      twitter: ""
    },
    description:
      "Lamine Diallo is the founder of EtherAfrica. He is currently touring Africa, where he is popularizing Blockchain technology and organizing various conferences.As a telecom network engineer working in France, he has over eight years of professional experience in the design and implementation of unified communications, voice over IP and collaboration solutions for large accounts such as Societe Generale, Credit Agricole , L’Oréal and Orange business services.",
    image: lamine,
    tag: "ambassador"
  },
  {
